  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify proof request templates with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "outcome-taxonomy",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify outcome taxonomy with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify sponsor report outline with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify student growth evidence with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
