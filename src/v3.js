export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Impact Proof Command Center",
        "Operational table: Proof packets",
    ...
    "releaseChecklist": [
        ...
        "Proof Completeness reaches production threshold",
        "Attribution Confidence is documented with evidence",
        "Sponsor Readiness has no unresolved blocker",
        "Impact packet verified",
        "Sponsor report verified",
        "Grant appendix verified"
    ],
    "operations": [
