...
### A lightweight system for collecting proof that Volta’s work improved business and student outcomes.
...
**Student Agency Operations** · **Repo 50/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/50-impact-proof-kit/) · [Report an issue](https://github.com/volta-npo/50-impact-proof-kit/issues) · [Volta](https://voltanpo.org)
...
**Impact Proof Kit** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Volta leadership, chapters, sponsors, and grant writers turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Impact claims need evidence across client, student, and community dimensions.

### The niche

Evidence infrastructure for student-powered social enterprise.

### North-star metric

`projects with complete impact proof packets`
...
flowchart TD
    ...
    Evidence --> Workbench["Impact Proof Kit"]
    Workbench --> Score["Operating readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Impact packet"]
    Cert --> A2["Sponsor report"]
    Cert --> A3["Grant appendix"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Proof request templates"]
        M2["Outcome taxonomy"]
        M3["Sponsor report outline"]
        M4["Student growth evidence"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Impact Proof Kit
...
|---|---|
| **Domain workbench** | A purpose-built impact proof interface for a lightweight system for collecting proof that volta’s work improved business and student outcomes. |
...
|---:|---|---|
| 1 | **Proof request templates** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Outcome taxonomy** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Sponsor report outline** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Student growth evidence** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
- Baseline and follow-up required
- Source attached for every claim
- Privacy review before sponsor export
...
```bash
git clone https://github.com/volta-npo/50-impact-proof-kit.git
cd 50-impact-proof-kit
npm test
npm start
```
